...
export const metadata: Metadata = {
  ...
  description: "How Luna Plants collects, uses and protects your personal data under UK GDPR.",
};
  ...
  return (
    <main className="legal-page">
      <div className="site-container legal-container">
        ...
        <section>
          <h2>1. Who we are</h2>
          <p>Luna Plants is a trading name of Lunaplants. We are the data controller for personal data collected through lunaplants.co.uk. Our address is The Fairmont, Kitty Lane, FY4 5EG, United Kingdom. Contact us at <a href="mailto:hello@lunaplants.co.uk">hello@lunaplants.co.uk</a>.</p>
        </section>
        ...
        <section>
          ...
          <ul>
            <li><strong>Fulfilling orders</strong> (contractual necessity): processing payment, printing and dispatching your order, sending order confirmations and delivery updates</li>
        ...
        <section>
          ...
          <p>To exercise any of these rights, email <a href="mailto:hello@lunaplants.co.uk">hello@lunaplants.co.uk</a>. We will respond within one month.</p>
        </section>
