...
export const metadata: Metadata = {
  ...
  description: "Contact Luna about an order, plant care, delivery or trade enquiries. Find answers to common questions about our made-to-order plant pots.",
};

const faqs = [
  ["Does the plant arrive inside the decorative pot?", "Yes. The plant stays in a fitted, removable nursery liner inside your Luna pot. It arrives composed and ready to place, while the liner keeps watering straightforward."],
...
export default function ContactPage() {
  ...
  return (
    <main className="contact-page">
      ...
      <section className="contact-main"><div className="site-container contact-grid"><div className="contact-details"><span className="eyebrow">Contact Luna</span><h2>A small team,<br />with real replies.</h2><p>We answer messages Monday to Friday and usually come back within two working days.</p><div className="contact-methods"><a href="mailto:hello@lunaplants.co.uk"><Mail size={20} /><span><small>Email</small>hello@lunaplants.co.uk</span></a><div><MapPin size={20} /><span><small>Studio</small>Bristol, United Kingdom</span></div><a href="https://www.instagram.com"><MessageCircle size={20} /><span><small>Social</small>@lunaplants</span></a></div></div><ContactForm /></div></section>
