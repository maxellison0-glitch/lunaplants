...
export const metadata: Metadata = {
  title: "Cookie Policy",
  description: "How Luna Plants uses cookies and similar technologies on lunaplants.co.uk.",
};
    ...
    <main className="legal-page">
      <div className="site-container legal-container">
        ...
        <section>
          ...
          <p>For details on how we handle personal data, see our <Link href="/privacy">Privacy Notice</Link>. For any questions, email <a href="mailto:hello@lunaplants.co.uk">hello@lunaplants.co.uk</a>.</p>
        </section>
      </div>
    </main>
  );
